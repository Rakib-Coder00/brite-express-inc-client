        ...
        <div>
            <div className="qna-container min-vh-100">
                ...
                <p className='text-muted'>BRITE EXPRESS IS CHICAGO BASED TRUCKING COMPANY ESTABLISHED IN 2009. WE HAVE 60% OF ACCOUNT DEDICATED LANES. ALL THE CORE PROCESSES ARE SIMPLIFIED, DOCUMENTED AND FBA.
                    ...
                    ON THIS PAGE, YOU WILL FIND FREQUENTLY ASKED QUESTIONS ABOUT BRITE LOGISTICS. <br /></p>
                <p>
                    We are based in Chicago, IL, where our first office was opened more than 11 years ago. Now our Chicago HQ is not just an office but a multi-functional distribution center with 130 000 sq.f. cross-dock warehouse..</p>
            </div>
        </div>
    );
};
